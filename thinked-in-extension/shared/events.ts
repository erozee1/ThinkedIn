/**
 * Shared event contract between the extension (producer) and the events API
 * (consumer). Single source of truth for both sides.
 *
 * Dependency-free and browser-safe — the extension client imports this directly.
